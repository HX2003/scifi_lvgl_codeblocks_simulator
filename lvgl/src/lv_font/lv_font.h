...
LV_FONT_DECLARE(lv_font_eurostyle_normal_12)

LV_FONT_DECLARE(lv_font_eurostyle_14)

LV_FONT_DECLARE(lv_font_eurostyle_16)

LV_FONT_DECLARE(lv_font_eurostyle_normal_18)
...
LV_FONT_DECLARE(lv_font_eurostyle_bold_extended_30)
