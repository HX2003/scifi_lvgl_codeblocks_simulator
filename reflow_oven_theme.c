...
static lv_style_t style_scifi_clock_main, style_scifi_clock_thick_needle, style_scifi_clock_thin_needle;
static lv_style_t style_btnmatrix;
static lv_style_t style_cpicker_bg;
static lv_style_t style_cpicker_indic;
/**********************
 *      MACROS
 **********************/
...
static void basic_init(void)
{
    ...
    lv_style_set_bg_color(&style_bg, LV_STATE_DEFAULT, REFLOW_OVEN_LIGHT);

    lv_style_init(&style_bg_transp);
    lv_style_set_bg_opa(&style_bg_transp, LV_STATE_DEFAULT, LV_OPA_TRANSP);

    lv_style_init(&style_box);
    lv_style_set_value_color(&style_box, LV_STATE_DEFAULT, REFLOW_OVEN_BLUE);
    ...
    lv_style_set_border_color(&style_box_border, LV_STATE_DEFAULT, REFLOW_OVEN_GRAY);
    ...
    lv_style_set_bg_color(&style_label, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    ...
    lv_style_set_radius(&style_btn, LV_STATE_DEFAULT, 2);
    lv_style_set_bg_opa(&style_btn, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_btn, LV_STATE_DEFAULT, lv_color_hex(0x3e4147));
    lv_style_set_bg_color(&style_btn, LV_STATE_CHECKED, lv_color_hex(0xf00000));
    lv_style_set_bg_color(&style_btn, LV_STATE_PRESSED|LV_STATE_CHECKED, lv_color_hex(0xf00000));
    lv_style_set_bg_color(&style_btn, LV_STATE_PRESSED, lv_color_darken(lv_color_hex(0x3e4147), LV_OPA_20));
    lv_style_set_text_color(&style_btn, LV_STATE_DEFAULT, LV_COLOR_GRAY);
    lv_style_set_text_color(&style_btn, LV_STATE_CHECKED, LV_COLOR_BLACK);
    lv_style_set_image_recolor(&style_btn, LV_STATE_DEFAULT, REFLOW_OVEN_BLUE);
    lv_style_set_image_recolor(&style_btn, LV_STATE_PRESSED, lv_color_darken(REFLOW_OVEN_BLUE, LV_OPA_20));
    lv_style_set_image_recolor(&style_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
    lv_style_set_transition_time(&style_btn, LV_STATE_DEFAULT, 200);
    lv_style_set_transition_prop_1(&style_btn, LV_STATE_DEFAULT, LV_STYLE_BG_COLOR);
    lv_style_set_pad_left(&style_btn, LV_STATE_DEFAULT, LV_HOR_RES / 25);
    lv_style_set_pad_right(&style_btn, LV_STATE_DEFAULT, LV_HOR_RES / 25);
    lv_style_set_pad_top(&style_btn, LV_STATE_DEFAULT, LV_HOR_RES / 100);
    lv_style_set_pad_bottom(&style_btn, LV_STATE_DEFAULT, LV_HOR_RES / 100);
    lv_style_set_pad_inner(&style_btn, LV_STATE_DEFAULT, LV_HOR_RES / 50);
    ...
    lv_style_set_transform_height(&style_btn_neutral, LV_STATE_PRESSED, LV_HOR_RES / 150);
    lv_style_set_transition_time(&style_btn_neutral, LV_STATE_DEFAULT, 100);
    lv_style_set_transition_delay(&style_btn_neutral, LV_STATE_PRESSED, 0);
    lv_style_set_transition_delay(&style_btn_neutral, LV_STATE_DEFAULT, 70);
    lv_style_set_transition_prop_1(&style_btn_neutral, LV_STATE_DEFAULT, LV_STYLE_TRANSFORM_WIDTH);
    ...
    lv_style_set_border_color(&style_btn_border, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    ...
    lv_style_set_bg_color(&style_btn_border, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    lv_style_set_bg_color(&style_btn_border, LV_STATE_PRESSED, LV_COLOR_WHITE);
    lv_style_set_text_color(&style_btn_border, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    lv_style_set_value_color(&style_btn_border, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    lv_style_set_transition_prop_1(&style_btn_border, LV_STATE_DEFAULT, LV_STYLE_BG_OPA);

    lv_style_init(&style_icon);
    lv_style_set_radius(&style_icon, LV_STATE_DEFAULT, 22);
    lv_style_set_image_recolor(&style_icon, LV_STATE_DEFAULT, LV_COLOR_BLACK);
    lv_style_set_image_recolor_opa(&style_icon, LV_STATE_PRESSED , LV_OPA_10);
    lv_style_set_image_recolor_opa(&style_icon, LV_STATE_FOCUSED, LV_OPA_20);
    lv_style_set_transform_zoom(&style_icon, LV_STATE_PRESSED, 230);
    lv_style_set_transform_zoom(&style_icon, LV_STATE_FOCUSED, 230);
    lv_style_set_shadow_width(&style_icon, LV_STATE_DEFAULT, 10);
    lv_style_set_shadow_color(&style_icon, LV_STATE_DEFAULT, lv_color_lighten(lv_color_hex(0), LV_OPA_20));
    lv_style_set_shadow_opa(&style_icon, LV_STATE_PRESSED, 0);
    lv_style_set_shadow_opa(&style_icon, LV_STATE_FOCUSED, 0);
    lv_style_set_shadow_ofs_x(&style_icon, LV_STATE_DEFAULT, -3);
    lv_style_set_shadow_ofs_y(&style_icon, LV_STATE_DEFAULT, 3);
    lv_style_set_transition_time(&style_icon, LV_STATE_DEFAULT, 100);
    lv_style_set_transition_delay(&style_icon, LV_STATE_DEFAULT, 70);
    lv_style_set_transition_prop_1(&style_icon, LV_STATE_DEFAULT, LV_STYLE_SHADOW_OPA);
    lv_style_set_transition_prop_2(&style_icon, LV_STATE_DEFAULT, LV_STYLE_IMAGE_RECOLOR_OPA);
    lv_style_set_transition_prop_3(&style_icon, LV_STATE_DEFAULT, LV_STYLE_TRANSFORM_ZOOM);

    lv_style_init(&style_cont);
    lv_style_set_bg_opa(&style_cont, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_cont, LV_STATE_DEFAULT, LV_COLOR_WHITE);
    lv_style_set_bg_color(&style_cont, LV_STATE_PRESSED, REFLOW_OVEN_LIGHT_GRAY);
    lv_style_set_bg_color(&style_cont, LV_STATE_FOCUSED, REFLOW_OVEN_LIGHT_GRAY);
    lv_style_set_bg_color(&style_cont, LV_STATE_CHECKED, REFLOW_OVEN_GRAY);

    lv_style_init(&style_icon_label);
    lv_style_set_transition_time(&style_icon_label, LV_STATE_DEFAULT, 100);
    lv_style_set_transition_delay(&style_icon_label, LV_STATE_DEFAULT, 70);
    lv_style_set_transition_prop_1(&style_icon_label, LV_STATE_DEFAULT, LV_STYLE_TRANSFORM_ZOOM);

    lv_style_init(&style_chart);
    lv_style_set_size(&style_chart, LV_STATE_DEFAULT, 0);
    lv_style_set_line_rounded(&style_chart, 0, 0);
    lv_style_set_line_width(&style_chart, LV_STATE_DEFAULT, 2);
    lv_style_set_bg_opa(&style_chart, LV_STATE_DEFAULT, LV_OPA_50);
    ...
    lv_style_set_value_color(&style_back, LV_STATE_PRESSED, REFLOW_OVEN_LIGHT_GRAY);
    ...
    lv_style_set_bg_color(&style_bar_bg, LV_STATE_DEFAULT, REFLOW_OVEN_LIGHT_GRAY);

    lv_style_init(&style_bar_indic);
    lv_style_set_bg_color(&style_bar_indic, LV_STATE_DEFAULT, REFLOW_OVEN_LIGHT_GREEN);
    ...
    lv_style_set_bg_color(&style_scrollbar, LV_STATE_DEFAULT, REFLOW_OVEN_LIGHT_GRAY);
    ...
    lv_style_set_bg_color(&style_list_btn, LV_STATE_PRESSED, REFLOW_OVEN_LIGHT_GRAY);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_FOCUSED, REFLOW_OVEN_LIGHT_GRAY);
    lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED, REFLOW_OVEN_GRAY);
    lv_style_set_text_color(&style_list_btn, LV_STATE_DEFAULT, REFLOW_OVEN_BLUE);
    lv_style_set_text_color(&style_list_btn, LV_STATE_PRESSED, lv_color_darken(REFLOW_OVEN_BLUE, LV_OPA_20));
    lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED, LV_COLOR_WHITE);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_DEFAULT, REFLOW_OVEN_BLUE);
    lv_style_set_image_recolor(&style_list_btn, LV_STATE_PRESSED, lv_color_darken(REFLOW_OVEN_BLUE, LV_OPA_20));
    ...
    lv_style_set_shadow_color(&style_ddlist_list, LV_STATE_DEFAULT, REFLOW_OVEN_GRAY);

    lv_style_init(&style_ddlist_selected);
    lv_style_set_bg_opa(&style_ddlist_selected, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_DEFAULT, REFLOW_OVEN_LIGHT_GRAY);
    lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_PRESSED, REFLOW_OVEN_LIGHT_GRAY);
    lv_style_set_text_color(&style_ddlist_selected, LV_STATE_PRESSED, lv_color_darken(REFLOW_OVEN_GRAY, LV_OPA_20));
    ...
    lv_style_set_bg_color(&style_sw_indic, LV_STATE_DEFAULT, REFLOW_OVEN_GREEN);
    ...
    lv_style_set_pad_left(&style_slider_knob, LV_STATE_DEFAULT, 4);
    lv_style_set_pad_right(&style_slider_knob, LV_STATE_DEFAULT, 4);
    lv_style_set_pad_top(&style_slider_knob, LV_STATE_EDITED, 6);
    lv_style_set_pad_bottom(&style_slider_knob, LV_STATE_EDITED, 6);
    lv_style_set_pad_left(&style_slider_knob, LV_STATE_EDITED, 6);
    lv_style_set_pad_right(&style_slider_knob, LV_STATE_EDITED, 6);
    ...
    lv_style_set_value_color(&style_arc_bg, LV_STATE_DEFAULT, LV_COLOR_WHITE);

    lv_style_init(&style_scifi_clock_main);
    lv_style_set_line_color(&style_scifi_clock_main, LV_STATE_DEFAULT, lv_color_hex(0x5c8cf4));
    lv_style_set_line_width(&style_scifi_clock_main, LV_STATE_DEFAULT, 2);
    lv_style_set_radius(&style_scifi_clock_main, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);

    lv_style_init(&style_scifi_clock_thick_needle);
    lv_style_set_line_color(&style_scifi_clock_thick_needle, LV_STATE_DEFAULT, lv_color_hex(0x5c8cf4));
    lv_style_set_line_width(&style_scifi_clock_thick_needle, LV_STATE_DEFAULT, 2);
    lv_style_set_line_rounded(&style_scifi_clock_thick_needle, LV_STATE_DEFAULT, true);
    lv_style_set_pad_inner(&style_scifi_clock_thick_needle, LV_STATE_DEFAULT, 5);

    lv_style_init(&style_scifi_clock_thin_needle);
    lv_style_set_line_color(&style_scifi_clock_thin_needle, LV_STATE_DEFAULT, lv_color_hex(0x5c8cf4));
    lv_style_set_line_width(&style_scifi_clock_thin_needle, LV_STATE_DEFAULT, 2);
    lv_style_set_line_rounded(&style_scifi_clock_thin_needle, LV_STATE_DEFAULT, true);
    lv_style_set_pad_inner(&style_scifi_clock_thin_needle, LV_STATE_DEFAULT, 3);

    lv_style_init(&style_btnmatrix);
    lv_style_set_pad_inner(&style_btnmatrix, LV_STATE_DEFAULT, 5);

    lv_style_init(&style_cpicker_bg);
    lv_style_set_scale_width(&style_cpicker_bg, LV_STATE_DEFAULT, 50);
    lv_style_set_bg_opa(&style_cpicker_bg, LV_STATE_DEFAULT, LV_OPA_COVER);
    lv_style_set_bg_color(&style_cpicker_bg, LV_STATE_DEFAULT, LV_COLOR_BLACK);
    lv_style_set_pad_inner(&style_cpicker_bg, LV_STATE_DEFAULT, 200);
    lv_style_set_radius(&style_cpicker_bg, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);

    lv_style_init(&style_cpicker_indic);
    lv_style_set_bg_opa(&style_cpicker_indic, LV_STATE_DEFAULT, LV_OPA_TRANSP);
}
...
static void theme_apply(lv_obj_t * obj, lv_theme_style_t name)
{
    ...
    switch(name_int) {
        ...
        case LV_THEME_CONT:
            ...
            _lv_style_list_add_style(list, &style_cont);
            break;
        ...
        case REFLOW_OVEN_THEME_BTN_BACK:
            lv_obj_clean_style_list(obj, LV_BTN_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_BTN_PART_MAIN);
        ...
        case LV_THEME_BAR:
            ...
            _lv_style_list_add_style(list, &style_bar_bg);
        ...
        case LV_THEME_LABEL:
            ...
            list = lv_obj_get_style_list(obj, LV_LABEL_PART_MAIN);
             _lv_style_list_add_style(list, &style_label);
            break;

        case REFLOW_OVEN_THEME_TITLE:
            lv_obj_clean_style_list(obj, LV_LABEL_PART_MAIN);
            list = lv_obj_get_style_list(obj, LV_LABEL_PART_MAIN);
        ...
        case LV_THEME_DROPDOWN:
            ...
            _lv_style_list_add_style(list, &style_scrollbar);
            break;
        case THEME_SCIFI_GAUGE:
            list = lv_obj_get_style_list(obj, SCIFI_CLOCK_PART_MAIN);
            _lv_style_list_add_style(list, &style_scifi_clock_main);

            list = lv_obj_get_style_list(obj, SCIFI_CLOCK_PART_THICK_NEEDLE);
            _lv_style_list_add_style(list, &style_scifi_clock_thick_needle);

            list = lv_obj_get_style_list(obj, SCIFI_CLOCK_PART_THIN_NEEDLE);
            _lv_style_list_add_style(list, &style_scifi_clock_thin_needle);
            break;
        case LV_THEME_BTNMATRIX:
            list = lv_obj_get_style_list(obj, LV_BTNMATRIX_PART_BG);
            _lv_style_list_add_style(list, &style_bg_transp);
            _lv_style_list_add_style(list, &style_btnmatrix);
        ...
        case LV_THEME_CPICKER:
            ...
            _lv_style_list_add_style(list, &style_cpicker_bg);

            list = lv_obj_get_style_list(obj, LV_CPICKER_PART_KNOB);
            _lv_style_list_add_style(list, &style_cpicker_indic);
        default:
            break;
    }
