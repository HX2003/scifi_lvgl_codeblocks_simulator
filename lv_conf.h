 ...
 * Used if lvgl is binded to higher level lanf and the memory is managed by that language */
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  <windows.h>       /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (GetTickCount())     /*Expression evaluating to current systime in ms*/
 ...
 */
#define LV_FONT_CUSTOM_DECLARE  LV_FONT_DECLARE(lv_font_montserrat_10);
